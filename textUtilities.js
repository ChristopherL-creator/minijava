...
function sortOccurrencesOfArray(string){ 
    const wordArray = createArrayOfWordsFromString(string); 
    const sortByRecurringArray = wordArray.reduce((a, v) => (a[v] = (a[v] || 0) + 1, a), {});
    return sortByRecurringArray;
}
...
function occurenciesofEachWordToJson(sortByRecurringArray) {
    const jsonEachWordOccurrences = JSON.stringify(sortByRecurringArray, null, 2); 
...
exports.sortOccurrencesOfArray = sortOccurrencesOfArray; 
// exports.countOccurrenciesOfEachWord = countOccurrenciesOfEachWord; 
// exports.sortByMostRecurring = sortByMostRecurring; 
